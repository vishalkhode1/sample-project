 ...
 * @endcode
 */
$settings['hash_salt'] = '19WyLvv12bslgf1lBhRU-H88rGBCFWO6nK-lefMcv8ibJSzPwzVPqhokXN_uj9DQTmiRhbo1kQ';
...
$config['cohesion.settings']['api_key'] = "<insert_SS_API_Key>";
$config['cohesion.settings']['organization_key'] = "<insert_SS_Org_Key>";
